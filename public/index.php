...
//http://localhost/undergraduateapp/admin-analytics
get($_ENV["PROJECT_PATH"] . 'admin-analytics', 'app/Controllers/Admin-analytics.php');
post($_ENV["PROJECT_PATH"] . 'admin-analytics', 'app/Controllers/Admin-analytics.php');
