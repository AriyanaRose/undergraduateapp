...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-bullet">
        ...
        <li aria-current="page" class="breadcrumb-item active text-uppercase">Email Subscription Listing</li>
    </ol>
</nav>
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-4">
                            <h2>Email Subscription Listing</h2>
                        </div>
                        <div class="col-sm-8">
                ...
                <table class="table table-striped table-hover table-responsive-xl">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($admin_email as $data) :  ?>
                            <tr>
