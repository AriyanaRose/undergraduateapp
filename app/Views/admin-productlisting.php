...
<!--	URL: https://www.tutorialrepublic.com/snippets/preview.php?topic=bootstrap&file=elegant-table-design
                Bootstrap Elegant Table Design
            ...
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover table-responsive-xl">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($admin_productlist as $data) :  ?>
                            <tr>
                                <td><?php echo $data["product_id"]; ?></td>
                                <td><img src="<?php echo BASE_URL . $data["product_image1"]; ?>" alt="Generic placeholder image" width="200" class=""></td>
                                ...
                                <td><?php echo $data["product_format"]; ?></td>
